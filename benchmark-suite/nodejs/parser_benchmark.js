...
/**
 * DDEX Suite Node.js Parser Performance Benchmark
...
try {
    ...
    console.log('📦 Loaded ddex-parser from npm');
} catch (e) {
    ...
    try {
        ...
        console.error('❌ Could not load DDEX Parser bindings:', e2.message);
        process.exit(1);
    }
}
...
class NodejsBenchmarkSuite {
    ...
    async benchmarkFile(filePath) {
        ...
        try {
            ...
            console.log(`  ✅ Parse: ${parseTime.toFixed(2)}ms, Memory: ${memUsageMB.toFixed(1)}MB`);
    ...
    async run() {
        console.log('🚀 DDEX Suite Node.js Parser Performance Benchmark');
        ...
        console.log('\n🎉 Node.js parser benchmark completed!');
    }
}
